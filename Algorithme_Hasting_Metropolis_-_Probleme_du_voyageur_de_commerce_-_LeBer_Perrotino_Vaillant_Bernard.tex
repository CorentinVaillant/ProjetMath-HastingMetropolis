...
Une chaîne de Markov est dite homogène quand $\forall n \in \mathbb{N}$ :
\[
...
\begin{tcolorbox}[colback=white,colframe={rgb,255:red,150; green,56; blue,235},title=Procédure Hastings-Metropolis TSP]
\begin{enumerate}
...
\subsection{Brêves descriptions d'autres méthodes MCMC qui peuvent r"soudre le TSP}
