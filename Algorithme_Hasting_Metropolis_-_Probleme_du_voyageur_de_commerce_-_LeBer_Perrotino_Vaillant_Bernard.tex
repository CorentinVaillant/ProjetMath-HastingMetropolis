...
Afin de comprendre le déroulé de l'algorithme, on peut prendre un graphe d'un début d'une simulation de HM. Attention, il s'agit d'un espace à états continus ce qui diffère en soi du reste du rapport, bien que les propriétés y restent équivalentes. Cet exemple est visuel et simple donc pertinent pour comprendre le déroulé de l'algorithme. \\
