...
Ainsi, la suite $(X_n)_{n \in \mathbb{N}}$ est une chaîne de Markov, qui est un processus aléatoire vérifiant la propriété de Markov. % Moyen, oà redire.
% A LA.


Dit simplement, la probabilité de passer d'un état $X_n$ à $X_{n+1}$ ne dépend que de $X_n$, % dire ça en français !
