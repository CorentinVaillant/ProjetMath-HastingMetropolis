...
\begin{tcolorbox}[colback=white,colframe=yellow!80!black,title=Ancienne version de la sous-section~\ref{subsubsec: Matrice de transition en k-pas}]
...
\subsection{Classes d'équivalence et de communication}
