...
Soit $(X_n)_{n \in \mathbb{N}}$ une chaîne de Markov homogène, irréductible et apériodique à espace d'états fini. Alors, il existe une unique mesure invariante \( \pi \), et pour tout état initial \( i \in E \) et tout \( j \in E \),
\[
